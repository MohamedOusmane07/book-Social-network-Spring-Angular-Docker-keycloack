...
@EntityListeners(
    AuditingEntityListener
        .class) // EntityListener specifies the listener of an Entity. it can automatically save
// when the user has been created, modified, .... it ensures traceability and data
// management
...
public class User implements UserDetails, Principal {
  ...
  @ManyToMany(
      fetch =
          FetchType.EAGER) // The roles associated with this entity will be loaded automatically and
  // immediately when the main entity is retrieved from the database
